        ...
        <div class='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20'>
            ...
            <div>
                ...
                <ul class='space-y-4 text-gray-400 font-medium'>
                    <li><a href='/about' data-link class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>About Us</a></li>
                    <li><a href='#' class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>Our Classes</a></li>
                    <li><a href='#' class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>Pricing Plans</a></li>
                    <li><a href='#' class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>Trainers</a></li>
                    <li><a href='#' class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>Contact</a></li>
                </ul>
            </div>
