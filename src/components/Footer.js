        ...
        <div class='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20'>
            ...
            <div>
                ...
                <ul class='space-y-4 text-gray-400 font-medium'>
                    ...
                    <li><a href='/about' data-link class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>About</a></li>
                    <li><a href='/offer' data-link class='hover:text-amber-500 transition-colors flex items-center gap-2 group'><span class='w-1.5 h-1.5 bg-gray-800 rounded-full group-hover:bg-amber-500 transition-all'></span>Offer</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class='space-y-6'>
                    ...
                    <div class='flex items-center gap-4'>
                        ...
                        <p class='text-gray-400 font-medium'>111-111-111</p>
                    </div>
                    <div class='flex items-center gap-4'>
                        <div class='w-10 h-10 rounded-lg bg-gray-900 flex items-center justify-center shrink-0'>
