export function TrainerCard({ imageSrc, name, role }) {
    return /*html*/ `
        <div class='group relative overflow-hidden rounded-3xl cursor-pointer h-[500px] bg-zinc-900'>
            ...
            <div class='absolute top-6 right-6 flex flex-col gap-3 translate-x-12 group-hover:translate-x-0 transition-transform duration-500 delay-100'>
                <a href="#" class="w-10 h-10 bg-amber-500 text-black rounded-full flex items-center justify-center hover:bg-white transition-colors">
            ...
            <div class='absolute bottom-0 left-0 w-full p-8 translate-y-2 group-hover:translate-y-0 transition-transform duration-500'>
                ...
                <h3 class='text-3xl font-black text-white uppercase leading-tight mb-2'>
                    ${name}
                </h3>
                <p class='text-gray-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100'>
                    Passionate about helping you achieve your ultimate physical potential.
                </p>
            </div>
